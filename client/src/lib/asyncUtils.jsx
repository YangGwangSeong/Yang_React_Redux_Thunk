...
export const reducerUtils = {
    ...
    // 따로 값을 지정하면 null 로 바꾸지 않고 다른값을 유지시킬 수 있습니다.
    ...
    return (state, action) => {
        switch (action.type) {
            case type:
                return {
                    ...state,
                    [key]: reducerUtils.loading( keepData ? state[key].data : null) // 로딩할때 데이터 유지를 위해.
                };
            case SUCCESS : 
                return {
                    ...state,
...
export const createPromiseThunkById = (
    ...
    return param => async dispatch => {
        ...
        try{
            ...
            dispatch({ type : ERROR, error : true, payload : e, meta : id }); //  dispatch({ type : GET_POST_ERROR, error : e});
        }
    };
};
                ...
                return {
                    ...
                    [key]: {
                        ...
                        [id]: reducerUtils.loading(
                            // state[key][id] 가 만들어져있지 않을 수 도 있으니까 유효성을 먼저 검사 후 data 조회
